			...
			<div class="wrap">
				<div class="main clearfix">
					...
					<form id="registerForm"
						action="${ pageContext.request.contextPath }/user_regists.action"
							...
							<tbody>
								<tr>
									...
									<td><input type="text" id="username" name="username"
										class="text" maxlength="20" onblur="checkUser();" value=""/> <span
										id="alertUsername"></span></td>
								</tr>
								<tr>
									<th><span class="requiredField">*</span>密&nbsp;&nbsp;码:</th>
									<td><input type="password" id="password" name="password"
										class="text" maxlength="20" autocomplete="off" value="" /> <span><s:fielderror
								...
								<tr>
									<th>电话:</th>
									<td><input type="text" name="phone" class="text" /> <span><s:fielderror
												fieldName="phone" /></span></td>
								</tr>
								...
								<tr>
									...
									<td><span class="fieldSet"> <input type="text"
											...
											id="checkImage" class="captchaImage"
											src="${pageContext.request.contextPath}/checkImg.action"
											title="点击更换验证码" onclick="change()"></span><div><s:actionerror /></div></td>
								</tr>
								<tr>
									<th>&nbsp;</th>
