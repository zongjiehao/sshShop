...
<%@ include file="menu.jsp"%>
	...
	<s:if test="#session.cart.cartItems.size()!=0">
		<div class="span24">
			<div class="step step1">
					...
					<s:iterator value="#session.cart.cartItems" var="cartItem">
						<tr>
							<td width="60">
								...
								<img src="/pic/<s:property value="#cartItem.product.image"/>">
							</td>
							<td>
				...
				<div class="total">
					...
					赠送积分: <em id="effectivePoint"><s:property value="#session.cart.total"/>分</em>
		...
		<s:else>
			<div class="span24">
				<div class="step step1">
						<span><h2 align="center">亲,你还没有购物呢!</h2></span>
				</div>
			</div>
		</s:else>
	</div>
