			...
			<div class="hotProductCategory">
				<s:iterator value="#session.cList" var="category">
					<dl>
						<dt>
							<a
								href="${pageContext.request.contextPath}/product_findByCid.action?cid=<s:property
									value="#category.cid" />&page=1"><s:property
									value="#category.cname" /></a>
						</dt>
						<s:iterator value="#category.categorySeconds"
							var="categorySeconds">
							<dd>
								<a href="${pageContext.request.contextPath}/product_findByCsid.action?csid=<s:property value="#categorySeconds.csid"/>&page=1"><s:property value="#categorySeconds.csname" /></a>
							</dd>
						</s:iterator>
					</dl>
				</s:iterator>
			...
			<form id="productForm"
				...
				<div id="result" class="result table clearfix">
					<ul>
						<s:iterator value="pageBean.list" var="product">
							<li><a href="${pageContext.request.contextPath}/product_findByPid?pid=<s:property value="#product.pid" />"> <img
									src="/pic/<s:property value="#product.image" /> "
									width="170" height="170" style="display: inline-block;" /> <span
									style='color: green'> <s:property value="#product.pname" />
				...
				<div class="pagination">
					...
					<s:if test="pageBean.page!=pageBean.pageCount">
						<a class="nextPage"
							href="
						${pageContext.request.contextPath}/product_findByCid.action?cid=<s:property value="cid"/>
						&page=<s:property value="pageBean.page+1"/>">&nbsp;</a>
						<a class="lastPage"
							href="${pageContext.request.contextPath}/product_findByCid.action?cid=<s:property value="cid"/>&page=<s:property value="pageBean.pageCount"/>">&nbsp;</a>
					</s:if>
					</s:if>
					<s:if test="csid!=null">
					<s:if test="pageBean.page!=1">
					...
					<s:if test="pageBean.page!=pageBean.pageCount">
						<a class="nextPage"
							href="
						${pageContext.request.contextPath}/product_findByCsid.action?csid=<s:property value="csid"/>
						&page=<s:property value="pageBean.page+1"/>">&nbsp;</a>
						<a class="lastPage"
							href="${pageContext.request.contextPath}/product_findByCsid.action?csid=<s:property value="csid"/>&page=<s:property value="pageBean.pageCount"/>">&nbsp;</a>
					</s:if>
					</s:if>
				</div>
			</form>
