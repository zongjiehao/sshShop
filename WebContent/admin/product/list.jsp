...
<body>
	...
	<form id="Form1" name="Form1"
		...
		<table cellSpacing="1" cellPadding="0" width="100%" align="center"
			...
			<TBODY>
				<tr>
					<td class="ta_01" align="center" bgColor="#afd1f3"><strong>一级分类
							列 表</strong></TD>
				</tr>
				<tr>
						...
						<table cellspacing="0" cellpadding="1" rules="all"
							...
							<s:iterator var="p" value="pageBean.list" status="status">
								<tr onmouseover="this.style.backgroundColor = 'white'"
									...
									<td style="CURSOR: hand; HEIGHT: 22px" align="center"
										width="18%"><img width="40px" height="40px"
										src="/pic/<s:property value="#p.image"/>" />
									</td>
									<td style="CURSOR: hand; HEIGHT: 22px" align="center"
				...
				<tr align="center">
					<td class="ta_01" align="center" bgColor="#f5fafe">第<s:property
						...
						<s:if test="pageBean.page!=1">
							...
							<a
								href="${pageContext.request.contextPath}/adminProduct_findAll.action?page=<s:property value="pageBean.pageCount"/>">|&nbsp;尾页</a>
						</s:if>
					</td>
				</tr>
			</TBODY>
