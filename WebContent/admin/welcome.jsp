...
<form name="Form1" method="post" action="name.aspx" id="Form1">
	...
	<table width="100%" border="0" height="88" border="1" background="${pageContext.request.contextPath}/images/back1.JPG">
		...
		<tr>
			<td width="65%" height="400" align="center" valign="top" >
				<span class="Style1"><img alt="图片丢失"width="100%" height="100%" src="${pageContext.request.contextPath}/images/success.jpg"></span>
			</td>
		</tr>
